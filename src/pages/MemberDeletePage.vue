<template>
  <div class="p-3">
    <p class="text-muted small mb-5">※ 자신이 총관리자인 스터디가 있을 경우, 회원을 탈퇴할 수 없습니다.</p>
    <div class="d-flex justify-content-center align-items-center h-100">
      <div class="card p-5 shadow rounded text-center" style="width: 700px">
        ...
        <p class="mb-1 text-secondary">그동안 <strong class="text-dark">Study With</strong> 서비스를 이용해주셔서 감사합니다.</p>
        <p class="mb-4 text-secondary">회원을 탈퇴한 후에는 <span class="text-danger fw-bold">다시 복구할 수 없습니다.</span></p>
